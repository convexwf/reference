...
- [导读](#导读)
  - [开篇词  这一次，让我们一起来搞懂MySQL](#开篇词-这一次让我们一起来搞懂mysql)
- [基础架构、事务与索引](#基础架构事务与索引)
  - [基础架构：一条SQL查询语句是如何执行的？](#基础架构一条sql查询语句是如何执行的)
  - [日志系统：一条SQL更新语句是如何执行的？](#日志系统一条sql更新语句是如何执行的)
  - [事务隔离：为什么你改了我还看不见？](#事务隔离为什么你改了我还看不见)
  - [深入浅出索引（上）](#深入浅出索引上)
  - [深入浅出索引（下）](#深入浅出索引下)
  - [全局锁和表锁 ：给表加个字段怎么有这么多阻碍？](#全局锁和表锁-给表加个字段怎么有这么多阻碍)
  - [行锁功过：怎么减少行锁对性能的影响？](#行锁功过怎么减少行锁对性能的影响)
  - [事务到底是隔离的还是不隔离的？](#事务到底是隔离的还是不隔离的)
  - [普通索引和唯一索引，应该怎么选择？](#普通索引和唯一索引应该怎么选择)
  - [MySQL为什么有时候会选错索引？](#mysql为什么有时候会选错索引)
  - [怎么给字符串字段加索引？](#怎么给字符串字段加索引)
  - [为什么我的MySQL会“抖”一下？](#为什么我的mysql会抖一下)
  - [为什么表数据删掉一半，表文件大小不变？](#为什么表数据删掉一半表文件大小不变)
  - [count()这么慢，我该怎么办？](#count这么慢我该怎么办)
  - [答疑文章（一）：日志和索引相关问题](#答疑文章一日志和索引相关问题)
- [查询执行与锁](#查询执行与锁)
  - [“order by”是怎么工作的？](#order-by是怎么工作的)
  - [如何正确地显示随机消息？](#如何正确地显示随机消息)
  - [为什么这些SQL语句逻辑相同，性能却差异巨大？](#为什么这些sql语句逻辑相同性能却差异巨大)
  - [为什么我只查一行的语句，也执行这么慢？](#为什么我只查一行的语句也执行这么慢)
  - [幻读是什么，幻读有什么问题？](#幻读是什么幻读有什么问题)
  - [为什么我只改一行的语句，锁这么多？](#为什么我只改一行的语句锁这么多)
  - [MySQL有哪些“饮鸩止渴”提高性能的方法？](#mysql有哪些饮鸩止渴提高性能的方法)
- [日志、复制与高可用](#日志复制与高可用)
  - [MySQL是怎么保证数据不丢的？](#mysql是怎么保证数据不丢的)
  - [MySQL是怎么保证主备一致的？](#mysql是怎么保证主备一致的)
  - [MySQL是怎么保证高可用的？](#mysql是怎么保证高可用的)
  - [备库为什么会延迟好几个小时？](#备库为什么会延迟好几个小时)
  - [主库出问题了，从库怎么办？](#主库出问题了从库怎么办)
  - [读写分离有哪些坑？](#读写分离有哪些坑)
  - [如何判断一个数据库是不是出问题了？](#如何判断一个数据库是不是出问题了)
  - [答疑文章（二）：用动态的观点看加锁](#答疑文章二用动态的观点看加锁)
- [运维与内部机制](#运维与内部机制)
  - [误删数据后除了跑路，还能怎么办？](#误删数据后除了跑路还能怎么办)
  ...
  - [都说InnoDB好，那还要不要使用Memory引擎？](#都说innodb好那还要不要使用memory引擎)
  - [自增主键为什么不是连续的？](#自增主键为什么不是连续的)
  - [insert语句的锁为什么这么多？](#insert语句的锁为什么这么多)
  - [怎么最快地复制一张表？](#怎么最快地复制一张表)
  - [grant之后要跟着flush privileges吗？](#grant之后要跟着flush-privileges吗)
  - [要不要使用分区表？](#要不要使用分区表)
  - [答疑文章（三）：说一说这些好问题](#答疑文章三说一说这些好问题)
  - [自增id用完怎么办？](#自增id用完怎么办)
- [扩展阅读与结束语](#扩展阅读与结束语)
  - [我的MySQL心路历程](#我的mysql心路历程)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/a78db0b99bbf1149c39b7960f7183c7e.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/0d2070e8f84c4801adbfa03bda1f98d9.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/f2da4aa3a672d48ec05df97b9f992fed.png) 客户端如果太长时间没动静，连接器就会自动将它断开。这个时间是由参数 wait_timeout 控制的，默认值是 8 小时。
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/16a7950217b3f0f4ed02db5db59562a7.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/2e5bff4910ec189fe1ee6e2ecc7b4bbe.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/7dea45932a6b722eb069d2264d0066f8.png) 我们来看看在不同的隔离级别下，事务 A 会有哪些不同的返回结果，也就是图里面 V1、V2、V3 的返回值分别是什么。
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/d9c313809e5ac148fc39feff532f0fee.png) 当前值是 4，但是在查询这条记录的时候，不同时刻启动的事务会有不同的 read-view。如图中看到的，在视图 A、B、C 里面，这一个记录的值分别是 1、2、4，同一条记录在系统中可以存在多个版本，就是数据库的多版本并发控制（MVCC）。对于 read-view A，要得到 1，就必须将当前值依次执行图中所有的回滚操作得到。
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/0c62b601afda86fe5d0fe57346ace957.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/bfc907a92f99cadf5493cf0afac9ca49.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/04fb9d24065635a6a637c25ba9ddde68.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/dcda101051f28502bd5c4402b292e38d.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/89f74c631110cfbc83298ef27dcd6370.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/b32aa8b1f75611e0759e52f5915539ac.jpg)

图 3 无索引下推执行流程

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/76e385f3df5a694cc4238c7b65acfe1b.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/cbfd4a0bbb1210792064bcea4e49b0cd.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/7cf6a3bf90d72d1f0fc156ececdfb0ce.jpg)
...
我先给你举个例子。在下面的操作序列中，事务 B 的 update 语句执行时会是什么现象呢？假设字段 id 是表 t 的主键。 ![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/51f501f718e420244b0a2ec2ce858710.jpg)
...
当并发系统中不同线程出现循环资源依赖，涉及的线程都在等待别的线程释放资源时，就会导致这几个线程都进入无限等待的状态，称为死锁。这里我用数据库中的行锁举个例子。 ![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/4d0eeec7b136371b79248a0aed005a52.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/823acf76e53c0bdba7beab45e72e90d6.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/68d08d277a6f7926a41cc5541d3dfced.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/882114aaf55861832b4270d44507695e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/9416c310e406519b7460437cb0c5c149.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/86ad7e8abe7bf16505b97718d8ac149f.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/cda2a0d7decb61e59dddc83ac51efb6e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/540967ea905e8b63630e496786d84c92.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/18fd5179b38c8c3804b313c3582cd1be.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/9b8fe7cf88c9ba40dc12e93e36c3060b.png) 复现出来以后，请你再思考一下，在实际的业务开发中有没有可能碰到这种情况？你的应用代码会不会掉进这个“坑”里，你又是怎么解决的呢？
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/1ed9536031d6698570ea175a7b7f9a46.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/980a2b786f0ea7adabef2e64fb4c4ca3.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/6dc743577af1dbcbb8550bddbfc5f98e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/be7a4d8af04cdf93aaa11108933559ae.png) 这样，session A 看到的就是我截图的效果了。

其实，还有另外一种场景，同学们在留言区都还没有提到。

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/
png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/8707b79d5ed906950749f5266014f22a.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/5008d7e9e22be88a9c80916df4f4b328.png)
...
不过，在 MySQL 5.7 版本下复现这个场景，也很容易。如图 3 所示，我给出了简单的复现步骤。 ![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/742249a31b83f4858c51bfe106a5daca.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/74fb24ba3826e3831eeeff1670990c01.png)
...
你可以看一下图 5。我查出来这个线程的状态是 Waiting for table flush，你可以设想一下这是什么原因。 ![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/2d8250398bc7f8f7dce8b6b1923c3724.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/2bbc77cfdb118b0d9ef3fdd679d0a69c.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/398407014180be4146c2d088fc07357e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/3e68326b967701c59770612183277475.png)

图 8 行锁复现

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/3c266e23fc307283aa94923ecbbc738f.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/d8603aeb4eaad3326699c13c46379118.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/d8b2b5f97c60ae4fc4a03c616847503c.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/66f26bb885401e8e460451ff6b0c0746.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/bde83e269d9fa185b27900c8aa8137d2.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/1fbb84bb392b6bfa93786fe032690b1c.png)

图 14 两个语句的输出结果

第一个语句的查询结果里 c=1，带 lock in share mode 的语句返回的是 c=1000001。看到这里应该有更多的同学知道原因了。如果你还是没有头绪的话，也别着急。我先跟你说明一下复现步骤，再分析原因。

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/84667a3449dc846e393142600ee7a2ff.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/46bb9f5e27854678bfcaeaf0c3b8a98c.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/5bc506e5884d21844126d26bbe6fa68b.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/7a9ffa90ac3cc78db6a51ff9b9075607.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/dcea7845ff0bdbee2622bf3c67d31d92.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/34ad6478281709da833856084a1e3447.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/e7f7ca0d3dab2f48c588d714ee3ac861.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/c435c765556c0f3735a6eda0779ff151.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/7c37732d936650f1cda7dbf27daf7498.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/df37bf0bb9f85ea59f0540e24eb6bcbe.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/0d796060073668ca169166a8903fbf3d.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/585dfa8d0dd71171a6fa16bed4ba816c.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/465990fe8f6b418ca3f9992bd1bb5465.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/30b839bf941f109b04f1a36c302aea80.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/7381475e9e951628c9fc907f5a57697a.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/b105f8c4633e8d3a84e6422b1b1a316d.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/c1fda36c1502606eb5be3908011ba159.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/b55fb0a1cac3500b60e1cf9779d2da78.png)
...
也就是说，这个 delete 语句在索引 c 上的加锁范围，就是下图中蓝色区域覆盖的部分。 ![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/bb0ad92483d71f0dcaeeef278f89cb24.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/afc3a08ae7a254b3251e41b2a6dae02e.png)
...
因此，索引 c 上的加锁范围就变成了从（c=5,id=5) 到（c=10,id=30) 这个前开后闭区间，如下图所示： ![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/e5408ed94b3d44985073255db63bd0d5.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/7b911a4c995706e8aa2dd96ff0f36506.png)
...
我把题目重新描述和简化一下：还是我们在文章开头初始化的表 t，里面有 6 条记录，图 12 的语句序列中，为什么 session B 的 insert 操作，会被锁住呢？ ![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/3a7578e104612a188a2d574eaa3bd81e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/9091ff280592c8c68665771b1516c62a.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/ae6a9ceecf8517e47f9ebfc565f0f925.png)

图 2 sleep 线程的两种状态，show processlist 结果

图中 id=4 和 id=5 的两个会话都是 Sleep 状态。而要看事务具体状态的话，你可以查 information_schema 库的 innodb_trx 表。

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/ca4b455c8eacbf32b98d1fe9ed9876e8.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/47a1002cbc4c05c74841591d20f7388a.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/3a7578e104612a188a2d574eaa3bd81e.png) 我们用上一篇的加锁规则来分析一下，看看 session A 的 select 语句加了哪些锁：
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/9ed86644d5f39efb0efec595abb92e3e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/9d057f61d3962407f413deebc80526d4.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/933fdc052c6339de2aa3bf3f65b188cc.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/98b3b4ff7b36d6d72e38029b86870551.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/5ae7d074c34bc5bd55c82781de670c28.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/fd75a2b37ae6ca709b7f16fe060c2c10.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/a66c154c1bc51e071dd2cc8c1d6ca6a3.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/b9818f73cd7d38a96ddcb75350b52931.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/96c2be9c0fcbff66883118526b26652b.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/d67a38db154afff610ae3bb64e266826.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/c342cf480d23b05d30a294b114cebfc2.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/0150301698979255a6f27711c35e9eef.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/1ad3a4c4b9a71955edba5195757dd041.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/20ad4e163115198dc6cf372d5116c956.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/89290bbcf454ff9a3dc5de42a85a69cc.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/54f4c7c31e6f0f807c2ab77f78c8844a.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/3786bd6ad37faa34aca25bf1a1d8af3a.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/b8d2229b2b40dd087fd3b111d1bdda43.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/553b7fc2d0dce3ec78bb595e1806eb8b.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/cf5ea52aa3b26ef56c567125197fa171.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/f968192ce2f436c939dd702b8f409771.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/1a85a3bac30a32438bfd8862e5a34eef.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/bcf75aa3b0f496699fd7885426bc6245.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/8b6976fedd6e644022d4026581fb8d76.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/f19916e27b8ff28e87ed3ad9f5473378.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/8fec5fb48d6095aecc80016826efbfc3.png)

图 5 主库并行事务

而按照 MariaDB 的并行复制策略，备库上的执行效果如图 6 所示。

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/8ac3799c1ff2f9833619a1624ca3e622.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/aadb3b956d1ffc13ac46515a7d619e79.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/0014f97423bd75235a9187f492fb2453.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/3471dfe4aebcccfaec0523a08cdd0ddd.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/28a5cab0079fb12fd5abecd92b3324c2.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/c8d3299ece7d583a3ecd1557851ed157.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/1334b9c08b8fd837832fdb2d82e6b0aa.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/065ef246c59019effc8384967d774318.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/00110923007513e865d7f43a124887c1.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/557445207b57d6c0f2747509d7d6619e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/9cf54f3e91dc8f7b8947d7d8e384aa09.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/b20ae91ea46803df1b63ed683e1de357.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/d521de8017297aff59db2f68170ee739.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/973bdd8741f830acebe005cbf37a7663.png)

图 8 显示更新事务的 GTID– 代码

这样，就可以看到语句执行完成，显示出 GITD 的值。

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/253106d31d9d97aaa2846b2015f593fe.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/35076dd3d0a0d44d22b76d2a29885255.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/3206ea18b8a24b546515b1b95dc4a11d.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/752ccfe43b4eab155be17401838c62dd.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/ac1aa07860c565b907b32c5f75c4f2bb.png)
...
这条查询语句里用的是 in，我们先来看这条语句的 explain 结果。 ![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/8a089159c82c1458b26e2756583347b3.png)
...
图 3 是在出现死锁后，执行 show engine innodb status 命令得到的部分输出。这个命令会输出很多信息，有一节 LATESTDETECTED DEADLOCK，就是记录的最后一次死锁信息。 ![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/a7dccb91bc17d12746703eb194775cf6.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/af3602b81aeb49e33577ba372d220a75.png)

图 4 delete 导致间隙变化

可以看到，由于 session A 并没有锁住 c=10 这个记录，所以 session B 删除 id=10 这一行是可以的。但是之后，session B 再想 insert id=10 这一行回去就不行了。

现在我们一起看一下此时 show engine innodb status 的结果，看看能不能给我们一些提示。锁信息是在这个命令输出结果的 TRANSACTIONS 这一节。你可以在文稿中看到这张图片 ![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/c3744fb7b61df2a5b45b8eb1f2a853a6.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/61c1ceea7b59201649c2514c9db864a7.png)
...
按照我们上一节说的，索引 c 上 (5,10) 间隙是由这个间隙右边的记录，也就是 c=10 定义的。所以通过这个操作，session A 的加锁范围变成了图 7 所示的样子： ![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/d2f6a0c46dd8d12f6a90dacc466d53e9.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/2fafd0b75286e0163f432f85428ff8db.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/65bb04929b8235fb677c7a78b5bd67f1.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/12eb6a38c347203f60df72ecaea95565.png)

图 3 复现空表的 next-key lock

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/531b6556ffc82c6b02f9a010a3ceb09f.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/17f88dc70c3fbe06a7738a0ac01db4d0.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/32e4341409fabfe271db3dd4c4df696e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/915c20e4c11b104d7bcf9d3457304c53.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/7e4666bfd580505180c77447d1f44c83.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/a027c300d7dde8cea4fad8f34b670ebd.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/183a704d4495bebbc13c524695b5b6c3.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/7640b0d82965bf8b305514f30425424b.png)

图 3 读全表被锁

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/84533515cf36be65582309fbb85e13c0.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/c70a95ee99826812c292c46de508982e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/e0ac92febac50a5d881f1188ea5bfd65.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/25e18920dd204cf99eec2d62755fe99e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/4b9cb0e0b83618e01c9bfde44a0ea990.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/d83ad1cbd6118603be795b26d38f8df6.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/15ae4f17c46bf71e8349a8f2ef70d573.jpg)

图 3 Block Nested-Loop Join 算法的执行流程

对应地，这条 SQL 语句的 explain 结果如下所示：

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/676921fa0883e9463dd34fb2bc5e87e1.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/695adf810fcdb07e393467bcfd2f6ac4.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/1761edbd7734276ae0a213af3cdd3311.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/d502fbaea7cac6f815c626b078da86c7.jpg)

图 2 MRR 执行流程

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/a513d07ebaf1ae044d44391c89bc6432.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/10e14e8b9691ac6337d457172b641a3d.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/31d85666542b9cb0b47a447a8593a47e.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/92fbdbfc35da3040396401250cb33f60.png)

图 6 explain 结果

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/d862bc3e88305688df2c354a4b26809c.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/a80cdffe8173fa0fd8969ed976ac6ac7.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/3cbb2843ef9a84ee582330fb1bd0d6e3.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/ddb9c43526dfd9b9a3e6f8c153478181.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/f5ebe0f5af37deeb4d0b63d6fb11fc0d.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/22078eab5c7688c9fbfd6185555bd91b.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/74e789024f10bcde515f21c0368847ba.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/333ad95b2ce16de1931fe347128caff9.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/402cbdef84eef8f1b42201c6ec4bad4e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/5d038c1366d375cc997005a5d65c600e.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/c1e90d1d7417b484d566b95720fe3f6d.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/3d1cb94589b6b3c4bb57b0bdfa385d98.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/0399382169faf50fc1b354099af71954.jpg)

图 5 group by 执行流程

图中最后一步，对内存临时表的排序，在[第 17 篇文章]中已经有过介绍，我把图贴过来，方便你回顾。

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/b5168d201f5a89de3b424ede2ebf3d68.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/ae6a28d890efc35ee4d07f694068f455.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/036634e53276eaf8535c3442805dfaeb.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/a76381d0f3c947292cc28198901f9e6e.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/5c4a581c324c1f6702f9a2c70acddd19.jpg)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/c9f88fa42d92cf7dde78fca26c4798b9.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/8269dc6206a7ef20cb515c23df0b846a.jpg)

图 12 使用 SQL_BIG_RESULT 的执行流程图

![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/83b6cd6b3e37dfbf9699cf0ccc0f1bec.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets/3fb1100b6e3390357d4efff0ba4765e6.png)
...
![img](https://raw.githubusercontent.com/Yvan0329/lianglianglee/4afe4a62c4e105a59d41319a29e523eee3bd82c4/book/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2/assets